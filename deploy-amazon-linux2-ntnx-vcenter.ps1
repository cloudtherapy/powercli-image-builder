...
Connect-VIServer ntnx-vcenter.cetech-nj.local

# Load OVF/OVA configuration from NAS share into a variable

$ovfPath = "\\njnas\downloads\OVAs\amzn2-vmware_esx-2.0.20210617.0-x86_64.xfs.gpt.ova"
$ovfConfig = Get-OvfConfiguration -Ovf $ovfPath

# vSphere Cluster + Network configurations
$Cluster = Get-Cluster -Name "Lenovo-NTNX"
$VMName = "cetech-amzn2"
...
Copy-DatastoreItem -Item "\\njnas\downloads\OVAs\seed.iso" -Destination "ds:\ISO\Amazon\"
